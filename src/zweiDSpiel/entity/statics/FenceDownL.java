...
public class FenceDownL extends StaticEntity {
	
	public FenceDownL(Handler handler, float x, float y)
	{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.fenceDownL, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
