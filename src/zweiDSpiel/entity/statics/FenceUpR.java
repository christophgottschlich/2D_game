...
public class FenceUpR extends StaticEntity {
	
	public FenceUpR(Handler handler, float x, float y)
	{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.fenceUpR, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
