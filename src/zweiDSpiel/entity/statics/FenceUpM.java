...
public class FenceUpM extends StaticEntity {
	
	public FenceUpM(Handler handler, float x, float y)
	{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.fenceUpM, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
