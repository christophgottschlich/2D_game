...
public class FenceDownR extends StaticEntity {
	
	public FenceDownR(Handler handler, float x, float y)
	{
	...
	public void render(Graphics g) {
		g.drawImage(Assets.fenceDownR, (int) (x - handler.getGameCamera().getxOffset()), (int) (y - handler.getGameCamera().getyOffset()), width, height, null);
	}
